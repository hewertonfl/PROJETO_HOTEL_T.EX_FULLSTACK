...
function readUsersControl(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const users = yield userModel.readUsers();
...
function deactiveUserControl(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const users = yield userModel.deactiveUser(id);
...
function userUpdateControl(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const dados = req.body;
        try {
            yield userModel.userUpdate(id, dados);
